...
@register_model_provider('deepseek')
class ModelInstanceDeepseek(ModelInstance):
    def __init__(self, model_type: ModelInstanceType, **kwargs):
        super().__init__()
        self.model_type = model_type
        self.model_config_raw = kwargs
        self.model_config = None # type: ModelConfigLLM
    ...
    def to_BaseChatModel(self, **kwargs) -> BaseChatModel:
        if self.model_type == ModelInstanceType.LLM:
            ...
            f_kwargs = filter_valid_args(ChatDeepSeek, temp_kwargs)
